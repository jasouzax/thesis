...
% \textbf{Differentiation table of Related Literature}
% \begin{table}[H]
%     \centering
...
%         \hline
%         \textbf{Components} & \textbf{\textcite{zvori_teanu_2021}} & \textbf{\textcite{realsense2025}} & \textbf{\textcite{udayakumar_2025}} & \textbf{\textcite{ruan_2025}} & \textbf{\textcite{viancy_2024}} & \textbf{\textcite{hamilton_fletcher_2021}} & \textbf{Han \& Li (2025)} & \textbf{\textcite{commere_2023}} & \textbf{\textcite{zhao_2025}} & \textbf{World Navigation Hat} \\
%         \hline
...
%         \hline
%         \textbf{Patent Title} & \textbf{Authors} & \textbf{Parameters} & \textbf{Publication No.} & \textbf{Publication Date} \\
%         \hline
%         \textbf{Stereo Vision-Based Sensory Substitution for the Visually Impaired} & Simona Caraiman, Ovidiu Zagan & Stereo vision cameras, IMU integration, depth computation ($Z=\frac{f\cdot B}{d}$), obstacle-to-audio/haptic mapping & PMC6630569 & June 20, 2019 \\
%         \hline
%         \textbf{Evaluation of Short-Range Depth Sonifications for Visual-to-Auditory Sensory Substitution} & Louis Commère, Jérôme Rouat & LiDAR depth sensing, LiDAR-to-repetition rate mapping ($R=\frac{k}{D}$), temporal density sonification & arXiv:2304.05462 & April 11, 2023 \\
%         \hline
%         \textbf{Aural Vision – Envisioning the Independence of the Visually Impaired} & V. V., N. R. C. Mouli, M. M., S. S. & Dual cameras, IMU sensors, reinforcement learning, ObjectNet3D dataset, visual-to-audio translation & IEEE DOI: 10.1109/ICICT60155.2024.10545004 & April 2024 \\
%         \hline
%         \textbf{SoundSight: A Mobile Sensory Substitution Device That Sonifies Colour, Distance, and Temperature} & Giles Hamilton-Fletcher, J. Arias & RGB-D camera, thermal sensor, multi-feature translation (color, depth, temperature), formulas ($f_c=k_cH$), ($A_t=k_tT$) & DOI: 10.1007/s12193-021-00376-w & July 2, 2021 \\
%         \hline
%         \textbf{Multi-Path Sensory Substitution Device for Navigation} & Zaidao Han, S. Li & Depth camera, IMU, A* pathfinding ($f(n)=g(n)+h(n)$), 3D occupancy mapping, audio-haptic feedback & ScienceDirect S0141938225002379 & August 27, 2025 \\
%         \hline
%         \textbf{Evaluation of the Efficacy of an Assistive Device for Blind People} & Yiming Zhao, S. Y. & Functional efficacy evaluation, accuracy ($\frac{Successful}{Total}\times100$), error rate, reaction time, 5-trial testing, 30 participants & Taylor \& Francis Online DOI: 10.1080/02713683.2025.2495212 & April 29, 2025 \\
%         \hline
%         \textbf{AI-Powered Smart Vision Glasses for the Visually Impaired} & Devi Udayakumar, S. Gopalakrishnan & LiDAR, RGB camera, AI fusion, gesture/voice control, mobile app integration & PMC12178407 & May 30, 2025 \\
%         \hline
%         \textbf{Multi-Faceted Sensory Substitution Using Wearable Technology for Curb Alerting} & Ligao Ruan, G. Hong, R. Fernández-Robles & Stereo disparity ($Z=\frac{f\cdot B}{d}$), ultrasonic sensors, audio-based curb detection, $94.3\%$ accuracy & DOI: 10.1080/17483107.2025.2463541 & February 1, 2025 \\
%         \hline
%         \textbf{Efficient Object Detection and Voice-Assisted Navigation: The Smart Hat Approach} & Memoona Sami, D. Abro & Raspberry Pi 4, ultrasonic sensor, camera, object detection-to-voice IoT system & Sukkur IBA Journal, SJ-CMS & December 2024 \\
%         \hline
%         \textbf{NIIRA: Non-Invasive Image Resynthesis into Audio (Sonic Vision for the Blind)} & RealSense \& Eyesynth Team & RealSense D415 camera, point-cloud depth mapping, SLAM, bone-conduction sound, obstacle detection up to 5 m & Intel RealSense Case Study & May 2025 \\
%         \hline
%     \end{tabularx}
% \end{table}
\begin{longtblr}[
...
\textbf{Patent Title} & \textbf{Authors} & \textbf{Parameters} & \textbf{Publication No.} & \textbf{Publication Date} \\
\textbf{Stereo Vision-Based Sensory Substitution for the Visually Impaired} & Simona Caraiman, Ovidiu Zagan & Stereo vision cameras, IMU integration, depth computation ($Z=\frac{f\cdot B}{d}$), obstacle-to-audio/haptic mapping & \seqsplit{PMC6630569} & June 20, 2019 \\
\textbf{Evaluation of Short-Range Depth Sonifications for Visual-to-Auditory Sensory Substitution} & Louis Commère, Jérôme Rouat & LiDAR depth sensing, LiDAR-to-repetition rate mapping ($R=\frac{k}{D}$), temporal density sonification & \seqsplit{arXiv:2304.05462} & April 11, 2023 \\
\textbf{Aural Vision -- Envisioning the Independence of the Visually Impaired} & V. V., N. R. C. Mouli, M. M., S. S. & Dual cameras, IMU sensors, reinforcement learning, ObjectNet3D dataset, visual-to-audio translation & \seqsplit{IEEE DOI: 10.1109/ICICT60155.2024.10545004} & April 2024 \\
\textbf{SoundSight: A Mobile Sensory Substitution Device That Sonifies Colour, Distance, and Temperature} & Giles Hamilton-Fletcher, J. Arias & RGB-D camera, thermal sensor, multi-feature translation (color, depth, temperature), formulas ($f_c=k_cH$), ($A_t=k_tT$) & \seqsplit{DOI: 10.1007/s12193-021-00376-w} & July 2, 2021 \\
\textbf{Multi-Path Sensory Substitution Device for Navigation} & Zaidao Han, S. Li & Depth camera, IMU, A* pathfinding ($f(n)=g(n)+h(n)$), 3D occupancy mapping, audio-haptic feedback & \seqsplit{ScienceDirect S0141938225002379} & August 27, 2025 \\
\textbf{Evaluation of the Efficacy of an Assistive Device for Blind People} & Yiming Zhao, S. Y. & Functional efficacy evaluation, accuracy ($\frac{Successful}{Total}\times100$), error rate, reaction time, 5-trial testing, 30 participants & \seqsplit{Taylor \& Francis Online DOI: 10.1080/02713683.2025.2495212} & April 29, 2025 \\
\textbf{AI-Powered Smart Vision Glasses for the Visually Impaired} & Devi Udayakumar, S. Gopalakrishnan & LiDAR, RGB camera, AI fusion, gesture/voice control, mobile app integration & \seqsplit{PMC12178407} & May 30, 2025 \\
\textbf{Multi-Faceted Sensory Substitution Using Wearable Technology for Curb Alerting} & Ligao Ruan, G. Hong, R. Fernández-Robles & Stereo disparity ($Z=\frac{f\cdot B}{d}$), ultrasonic sensors, audio-based curb detection, $94.3\%$ accuracy & \seqsplit{DOI: 10.1080/17483107.2025.2463541} & February 1, 2025 \\
\textbf{Efficient Object Detection and Voice-Assisted Navigation: The Smart Hat Approach} & Memoona Sami, D. Abro & Raspberry Pi 4, ultrasonic sensor, camera, object detection-to-voice IoT system & \seqsplit{Sukkur IBA Journal, SJ-CMS} & December 2024 \\
\textbf{NIIRA: Non-Invasive Image Resynthesis into Audio (Sonic Vision for the Blind)} & RealSense \& Eyesynth Team & RealSense D415 camera, point-cloud depth mapping, SLAM, bone-conduction sound, obstacle detection up to 5 m & \seqsplit{Intel RealSense Case Study} & May 2025 \\
\end{longtblr}